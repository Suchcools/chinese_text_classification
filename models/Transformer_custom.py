...
class Config(object):
    ...
    def __init__(self,):
        ...
        self.pad_size = 4200  # 每句话处理成的长度(短填长切) 145
        self.learning_rate = 0.000002  # 学习率
        self.embed = 1  # self.embedding_pretrained.size(1)\
...
print(model(torch.Tensor(2,4200,300).cuda()))